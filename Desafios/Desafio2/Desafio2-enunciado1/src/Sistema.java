public class Sistema {
    ...
    public void devolverElemento(Botella botella) {
        if(enProcesoDeDevolucion) {
            incrementarDepositosDiarios();
            incrementarDepositosCliente();

            valorTotalDevuelto += botella.getValorDevolucion();
        } else {
    ...
    public void devolverElemento(Envase envase) {
        if(enProcesoDeDevolucion) {
            incrementarDepositosDiarios();
            incrementarDepositosCliente();

            valorTotalDevuelto += envase.getValorDevolucion();
        } else {
            System.out.println("Error: Presione boton Inicio para comenzar a devolver elementos");
        }
    ...
    public void devolverElemento(Lata lata) {
        if(enProcesoDeDevolucion) {
            incrementarDepositosDiarios();
            incrementarDepositosCliente();

            valorTotalDevuelto += lata.getValorDevolucion();
        } else {
            System.out.println("Error: Presione boton Inicio para comenzar a devolver elementos");
        }
    ...
    public boolean isEnProcesoDeDevolucion() {
        return enProcesoDeDevolucion;
    }
